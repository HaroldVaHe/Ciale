...
| **Fase 6** | Done | Orders & Checkout — DB-backed orders from checkout, status panel, CL- ref in WhatsApp message |
...
| **Fase 6** | Hecho | Pedidos y Checkout — pedidos a BD desde checkout, panel con estados y referencia CL- en WhatsApp |
